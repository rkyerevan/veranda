...
const Post = (props) => {
  return(
    <div className='post'>
      ...
      <span>Donec sed odio dui. Nulla vitae elit libero, a pharetra augue. Vivamus sagittis lacus vel augue laoreet
            ...
            tempus porttitor. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</span>
    </div>
  )
}
